...
<div
  ...
  onClick={async () => {
    const response = await submitUserMessage(
      `O usuário escolheu a seguradora com a avalição de ${flight.avaliacao}, com o nome ${flight.seguradoraNome} e o número de registro CNPJ de: ${flight.CNPJ}. Please show the Forms UI, with toolname \`mostrarForms\` `
    )
